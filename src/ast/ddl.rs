...
impl fmt::Display for ColumnOption {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match self {
            ...
            DeferrableInitiallyDeferred => write!(f, "DEFERRABLE INITIALLY DEFERRED"),
            DeferrableInitiallyImmediate => write!(f, "DEFERRABLE INITIALLY IMMEDIATE"),
            NotDeferrable => write!(f, "NOT DEFERRABLE"),
        }
    }
}
