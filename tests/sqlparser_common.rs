                ...
                relation: TableFactor::Derived {
                    ...
                    subquery: Box::new(Query {
                        ...
                        body: Box::new(SetExpr::Select(Box::new(Select {
                            ...
                            lateral_views: vec![],
                            selection: None,
                            group_by: vec![Expr::Identifier(Ident::new("id").empty_span())],
                            cluster_by: vec![],
                            distribute_by: vec![],
                            sort_by: vec![],
                            having: None,
...
//         SelectItem::UnnamedExpr(WithSpan{inner: Expr::Collate { .. }, ..})
//     );
// }
//
// #[test]
...
fn parse_exponent_in_select() -> Result<(), ParserError> {
    ...
    assert_eq!(
        &vec![
            SelectItem::UnnamedExpr(Expr::Value(number("10e-20")).empty_span()).empty_span(),
            SelectItem::UnnamedExpr(Expr::Value(number("1e3")).empty_span()).empty_span(),
    ...
    chk(
        ...
        vec![TableWithJoins {
            relation: TableFactor::UNNEST {
                ...
                array_expr: Box::new(Expr::Identifier(Ident::new("expr").empty_span())),
                with_offset: true,
