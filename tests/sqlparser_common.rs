...
fn parse_insert_default_values() {
    ...
    match insert_with_default_values {
        Statement::Insert(Insert {
            ...
            assert_eq!(table_name, ObjectName::from(vec!["test_table".into()]));
        }
        _ => unreachable!(),
    }
...
fn parse_delete_statement_for_multi_tables() {
    ...
    match dialects.verified_stmt(sql) {
        Statement::Delete(Delete {
            ...
            assert_eq!(
                TableFactor::Table {
                    name: ObjectName::from(vec![Ident::new("schema1"), Ident::new("table1")]),
                    alias: None,
                    args: None,
                    with_hints: vec![],
                    version: None,
            ...
            assert_eq!(
                TableFactor::Table {
                    name: ObjectName::from(vec![Ident::new("schema2"), Ident::new("table2")]),
                    alias: None,
                    args: None,
                    with_hints: vec![],
                    version: None,
...
fn parse_implicit_join() {
    ...
    assert_eq!(
        vec![
            TableWithJoins {
                relation: TableFactor::Table {
                    name: ObjectName::from(vec!["t1".into()]),
                    alias: None,
                    args: None,
                    with_hints: vec![],
                    version: None,
            ...
            TableWithJoins {
                relation: TableFactor::Table {
                    name: ObjectName::from(vec!["t2".into()]),
                    alias: None,
                    args: None,
                    with_hints: vec![],
                    version: None,
    ...
    assert_eq!(
        vec![
            TableWithJoins {
                relation: TableFactor::Table {
                    name: ObjectName::from(vec!["t1a".into()]),
                    alias: None,
                    args: None,
                    with_hints: vec![],
                    version: None,
                ...
                joins: vec![Join {
                    relation: TableFactor::Table {
                        name: ObjectName::from(vec!["t1b".into()]),
                        alias: None,
                        args: None,
                        with_hints: vec![],
                        version: None,
            ...
            TableWithJoins {
                relation: TableFactor::Table {
                    name: ObjectName::from(vec!["t2a".into()]),
                    alias: None,
                    args: None,
                    with_hints: vec![],
                    version: None,
                ...
                joins: vec![Join {
                    relation: TableFactor::Table {
                        name: ObjectName::from(vec!["t2b".into()]),
                        alias: None,
                        args: None,
                        with_hints: vec![],
                        version: None,
        ...
        Statement::Unload {
            query: Box::new(Query {
                body: Box::new(SetExpr::Select(Box::new(Select {
                    ...
                    from: vec![TableWithJoins {
                        relation: TableFactor::Table {
                            name: ObjectName::from(vec![Ident::new("tab")]),
                            alias: None,
                            args: None,
                            with_hints: vec![],
                            version: None,
...
fn parse_connect_by() {
    let expect_query = Select {
        ...
        from: vec![TableWithJoins {
            relation: TableFactor::Table {
                name: ObjectName::from(vec![Ident::new("employees")]),
                alias: None,
                args: None,
                with_hints: vec![],
                version: None,
