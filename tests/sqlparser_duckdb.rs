...
fn test_duckdb_union_datatype() {
    ...
    assert_eq!(
        Statement::CreateTable(CreateTable {
            ...
            key_block_size: Default::default(),
            pack_keys: Default::default(),
            row_format: Default::default(),
            stats_auto_recalc: Default::default(),
            stats_persistent: Default::default(),
            stats_sample_pages: Default::default(),
            max_rows: Default::default(),
            min_rows: Default::default(),
            autoextend_size: Default::default(),
            avg_row_length: Default::default(),
            checksum: Default::default(),
            connection: Default::default(),
            engine_attribute: Default::default(),
            password: Default::default(),
            secondary_engine_attribute: Default::default(),
            tablespace_option: Default::default(),
            compression: Default::default(),
            delay_key_write: Default::default(),
            encryption: Default::default(),
            start_transaction: Default::default(),
            union_tables: Default::default(),
            index_directory: Default::default(),
