...
fn parse_create_table_generated_always_as_identity() {
    ...
    pg().one_statement_parses_to(
        sql,
        "CREATE TABLE table2 (column21 BIGINT PRIMARY KEY GENERATED ALWAYS AS IDENTITY , column22 BIGINT GENERATED ALWAYS AS IDENTITY , column22 BIGINT GENERATED BY DEFAULT AS IDENTITY , column23 TEXT)",
    );
}
