...
fn parse_create_table_generated_always_as_identity() {
    ...
    pg().one_statement_parses_to(
        sql,
        "CREATE TABLE table2 (column21 BIGINT PRIMARY KEY GENERATED ALWAYS AS IDENTITY , column22 BIGINT GENERATED ALWAYS AS IDENTITY , column22 BIGINT GENERATED BY DEFAULT AS IDENTITY , column23 BIGINT GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 MINVALUE 1 MAXVALUE 20 START WITH 10 CACHE 2 NO CYCLE ), column24 TEXT)",
    );
}
